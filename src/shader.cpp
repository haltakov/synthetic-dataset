...
bool SHADER_GLSL::UploadAttributeMat16(const string & varname, float * mat16)
{
	Enable();

	int mat_loc1 = glGetAttribLocation(program, (varname + "1").c_str());
	int mat_loc2 = glGetAttribLocation(program, (varname + "2").c_str());
	int mat_loc3 = glGetAttribLocation(program, (varname + "3").c_str());
	int mat_loc4 = glGetAttribLocation(program, (varname + "4").c_str());

	if (mat_loc1 >= 0 && mat_loc2 >= 0 && mat_loc3 >= 0 && mat_loc4 >= 0) {
		glVertexAttrib4fv(mat_loc1, mat16 +  0);
		glVertexAttrib4fv(mat_loc2, mat16 +  4);
		glVertexAttrib4fv(mat_loc3, mat16 +  8);
		glVertexAttrib4fv(mat_loc4, mat16 + 12);
