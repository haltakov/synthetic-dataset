...
void PATHMANAGER::Init(std::ostream & info_output, std::ostream & error_output, DATASET_RENDER_MODE mode)
{
	...
	switch (mode) {
	case RENDER_MODE_CAMERA:		profile_suffix = ".camera"; break;

	case RENDER_MODE_DEPTH: 
	case RENDER_MODE_FLOW_X:
	case RENDER_MODE_FLOW_Y:		profile_suffix = ".depth_flow"; break;

	case RENDER_MODE_SEGMENTATION:	
	case RENDER_MODE_POSE:			profile_suffix = ".segmentation"; break;
	}
